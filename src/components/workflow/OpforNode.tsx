...
export const OpforNode = memo(({ data, selected }: { data: OpforNodeData; selected?: boolean }) => {
  ...
  const c2Badge      = definition?.executionType ? C2_BADGE[definition.executionType] : undefined;
          ...
          {c2Badge && (
            <span
              style={{
                ...
                padding:       '1px 4px',
                borderRadius:  '3px',
                background:    c2Badge.hex + '22',
                color:         c2Badge.hex,
                border:        `1px solid ${c2Badge.hex}55`,
